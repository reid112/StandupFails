<template>
    <div>
        <div class="card"> 
            ...
            <p class="m-4 text-xl font-bold text-center">Fail Master:</p>
            <div class="text-center" v-if="isLoading"><n-spin size="large" /></div>
            <p v-else class="text-5xl text-center text-red">{{ biggestFailure ? biggestFailure.displayName : "---" }}</p>
        </div>
